...
@push('scripts')
<script>
const chartDefaults = { color: '#e0e0e0', borderColor: '#2a2a4a' };
...
new Chart(document.getElementById('genreChart'), {
    ...
    options: { plugins: { legend: { display: false } }, scales: { x: { grid: { color: '#2a2a4a' } }, y: { grid: { color: '#2a2a4a' }, ticks: { stepSize: 1 } } } }
});
</script>
@endpush
