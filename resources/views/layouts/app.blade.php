...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .sidebar-overlay {
            display: none; position: fixed; inset: 0; background: rgba(0,0,0,.6); z-index: 1039;
        }
...
<div class="topbar">
    <span class="brand">AniTrack</span>
    <button class="btn btn-sm btn-outline-secondary" id="sidebarToggle">Menu</button>
</div>
